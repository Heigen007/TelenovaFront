        ...
        <div class="container d-none d-lg-block mb-3">
            <div class="row">
                ...
                <div class="col-wd-3 d-none d-wd-block">
                   <a target='_blank' v-if='promoActions5Type.length > 0 && $store.state.promoActions'  :href="promoActions5Type[0].link"><img class="img-fluid d-block img360x330" :src="promoActions5Type[0].promoImages[Math.floor(Math.random() * (promoActions5Type[0].promoImages.length - 1))].clientPath" alt="Image Description"></a>
                    ...
                    <div class="col-lg-7">
                        <div class="row">
                            ...
                            <div class="col-12 col-md mb-4 mb-md-0">
                                ...
                                <div style='margin-bottom: 70px;' class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border u-header-topbar__nav-item-no-border u-header-topbar__nav-item-border-single">
...
export default {
    ...
    computed: {
        promoActions5Type(){
            return this.$store.state.promoActions.filter(el => el.typeOfPromo == 5).sort(() => Math.random() - 0.5);
        },
    }
}
</script>
