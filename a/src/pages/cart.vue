                                            ...
                                            <div class="d-block d-md-flex flex-center-between">
                                                <div class="mb-3 mb-md-0 w-xl-40">
                                                    ...
                                                    <form class="js-focus-state">
                                                        <label class="sr-only" for="subscribeSrEmailExample1">{{localizeFilter('CouponTitle')}}</label>
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-block btn-dark px-4" type="button" id="subscribeButtonExample2"><i class="fas fa-tags d-md-none"></i><span class="d-none d-md-inline">{{localizeFilter('CouponButtonTitle')}}</span></button>
                                                            </div>
                                                        </div>
                                                    </form>
                        ...
                        <div class="col-xl-5 col-lg-6 offset-lg-6 offset-xl-7 col-md-8 offset-md-4">
                            ...
                            <table class="table mb-3 mb-md-0">
                                <tbody>
                                    ...
                                    <tr class="shipping">
                                        <th>{{localizeFilter('CartConcludedSecondSubTitle')}}</th>
                                        <td data-title="Shipping">
                                            {{localizeFilter('CartConcludedSecondSubTitleFText')}}: <span class="amount">{{ShippingCost}} тг.</span>
                                            <div class="mt-1">
                                                <!-- <a class="font-size-12 text-gray-90 text-decoration-on underline-on-hover font-weight-bold mb-3 d-inline-block" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                    {{localizeFilter('CartConcludedSecondSubTitleSText')}}
                                                </a>
                                                <div class="collapse mb-3" id="collapseExample">
                                                    <div class="form-group mb-4">
                                                        <select class="js-select selectpicker dropdown-select right-dropdown-0-all w-100 border rounded-pill py-1 w-md-60 height-35 px-3 border-color-1"
