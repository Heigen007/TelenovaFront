                                                    ...
                                                    <div v-if="!el.offerData.category_list[2].includes('not show')" class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="flex-center-between mb-1">
                                                            ...
                                                            <div class="prodcut-price" v-else>
                                                                <ins style='color: red' class="font-size-18 text-decoration-none"><NuxtLink :to="'/product?id=' + el.offerData.kaspi_id"><div style='color: red'>{{Number(el.salePrice).toFixed(0)}}{{'\xa0'}}₸</div></NuxtLink></ins>
